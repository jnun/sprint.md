...
starts at a shared stop, and the raw file lines up at tab width W (default 4).
  ...
  ./docs/sprintbias/scripts/prettydoc.py docs/guides/*.md   # rewrite in place
  ./docs/sprintbias/scripts/prettydoc.py -                  # stdin -> stdout
...
(docs/sprintbias/guides/doc-style.md) for how to write docs this tool formats.
"""
import sys, re
