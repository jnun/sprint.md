...
<!-- Optional helpful hints that assist the developer in figuring out how to
     work the task: decisions, constraints, edge cases, gotchas. Leave empty
     if none. Fuel for their choice — not a required implementation plan. -->
