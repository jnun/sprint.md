# Task 320: Market positioning and findability research: map the agent-native text-based PM category language, competitors, and keywords/topics we should own
