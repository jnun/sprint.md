...
NEW_ID=$(alloc_id sprint_BUG_ID 'docs/bugs/[0-9]*-*.md') || {
    ...
    echo "Please fix docs/sprintbias/DOC_STATE.md manually. Expected format: '**sprint_BUG_ID**: NUMBER'"
    exit 1
}
...
git add docs/sprintbias/DOC_STATE.md "docs/bugs/$FILENAME" 2>/dev/null || true
