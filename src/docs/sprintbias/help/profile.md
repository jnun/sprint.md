...
with the user, and writes a flat profile to docs/sprintbias/project.md.
...
profile show cats docs/sprintbias/project.md, or prints a short "no
profile yet" message with the create command. No AI session is started.

After running profile (create/update):
  - docs/sprintbias/project.md exists with project conventions
