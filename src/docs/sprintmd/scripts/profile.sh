...
#
# profile        — interactive create/update of docs/sprintmd/project.md
...
PROFILE_REL="docs/sprintmd/project.md"
...
# profile is a dialogue (confirm fields) — sprintmd_run_interactive keeps the
